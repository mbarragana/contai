...
- **Recusar a gravação quando as datas divergem** — **proibido**: adendo 2,
  *"nunca recuse o registro de um fato consumado"*. Grava e abre pendência; o
  dente é o **bloqueio da discriminação do ano**.
