...
| **D75 — parser determinístico de retenção (`CONTAI-054`) calibrado com um único layout real de NFS-e** (padrão municipal SC, campo "ISSRF") | `docs/tickets/CONTAI-054.md` → cada novo layout real vira caso de teste próprio, nunca regra genérica antecipada; sem outro exemplo, não bloqueante |
