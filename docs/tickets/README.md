...
| **Saiu da fila, entregue** | `032`, `022` — commitados em 2026-09-19 (`13953f2`); `033`, `007`, `008`, `005`, `031`, `035` — entregues em 2026-09-20; `038`, `006`, `034`, `037` — entregues em 2026-09-21, todos pushados; ver "Em produção" |
...
`038`, `006`, `034` e `037` já pushados). **`014` saiu para "Parado,
