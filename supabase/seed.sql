...
--
-- ⚠️ `natureza_aquisicao_terreno` fica NULL de propósito (CONTAI-010): é o
-- estado da obra real do Mateus depois da migration 0008 — pendência de
-- complemento, nunca bloqueio. Os valores do terreno saíram da tabela `obra` e
-- viraram `terreno_desembolso`, cada um com a sua data.
insert into obra (
